...
| [linkedin-post.md](./linkedin-post.md) | LinkedIn Demo Post Creator | Transforms demo video transcripts into LinkedIn posts in Zach Rosenfield's voice. Covers four post types and includes a full workflow from transcript to published post. Tuned for SharePoint / Knowledge Agent content. |
