"""
make-assets.py — 08-smart-views-metadata
Generates demo asset files into assets/ subdirectory.
Run from repo root: python tools/scripts/08-smart-views-metadata/make-assets.py
Or from this folder: python make-assets.py

Same 6 files as demo 07 — uploaded during setup and auto-tagged by Copilot
so the library arrives at the demo section with fully populated metadata.

Expected metadata after setup auto-tag:
  HR-Policy.docx          -> HR        | Policy      | Internal
  Marketing-Proposal.docx -> Marketing | Proposal    | Internal
  Legal-Contract.docx     -> Legal     | Contract    | Confidential
  Finance-Report.docx     -> Marketing | Report      | Internal   (prepared by Finance for Marketing)
  NDA-Agreement.docx      -> Legal     | Contract    | Confidential
  Salary-Bands.docx       -> HR        | Report      | Restricted

Demo narrative depends on:
  - Filter Confidential/Restricted -> 3 results:
      Legal-Contract.docx, NDA-Agreement.docx, Salary-Bands.docx
  - Department breakdown: Marketing x2, HR x2, Legal x2
  - Missing departments flagged: Sales, Finance, Engineering, Operations
"""
...
# Generate assets
# ===========================================================================
print('Generating assets for 08-smart-views-metadata...')
